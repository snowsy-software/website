...
import { CodeXml, DiamondPlus, StickyNote, TabletSmartphone } from "lucide-react";
...
const featuresData: Feature[] = [
  {
    ...
    paragraph: "We specialize in building tailor-made software solutions that align perfectly with your business goals. From web applications to mobile apps, we deliver high-quality products that drive efficiency and growth.",
  },
  {
    id: 2,
    icon: <StickyNote className="h-10 w-10" />,
    title: "Landing Page & Website Development",
    paragraph: "We create stunning, responsive landing pages and websites that captivate your audience and enhance your online presence. Our designs are user-centric, ensuring an engaging experience that converts visitors into customers.",
  },
  {
    id: 3,
    icon: <TabletSmartphone className="h-10 w-10" />,
    title: "Mobile App Development",
    paragraph: "We develop intuitive and feature-rich mobile applications for both iOS and Android platforms. Our apps are designed to provide seamless user experiences, helping you connect with your audience on the go.",
  },
  {
    id: 4,
    icon: <DiamondPlus className="h-10 w-10" />,
    title: "Idea to MVP",
    paragraph: "Have a brilliant idea? We can help you transform it into a Minimum Viable Product (MVP). Our team works closely with you to validate your concept, develop a functional prototype, and prepare for market launch.",
  },
  /*
  {
    id: 5,
